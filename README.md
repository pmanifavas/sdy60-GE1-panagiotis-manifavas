...
- Συμμετοχή στη δημιουργία προσωπικών προϊόντων, χωρίς να χρειάζεται ο χρήστης να μπει στη διαδικασία να αλλάξει τα ρούχα του, εξοικονομώντας χρόνο[1][3].
...
- Χρήση αισθητήρων, καμερών , γεωτοποθεσίας αλλά και μέσω χειρονομιών για να αυξήσουν την εμεπιρία του χρήστη αλλά και να τον διευκολύνουν στη χρήση [1][4][5].
...
![loreal1](/images/loreal/Screenshot_20211107-120729_Style%20my%20hair.jpg)
...
![loreal4](/images/loreal/Screenshot_20211107-121001_Style%20my%20hair.jpg)
