...
1. Ο/Η χρήστης θα ανήκει στην ηλικιακή ομάδα 18-25 ετών και θα πρέπει να έχει εξοικείωση με τις εφαρμογές AR.
2. Στόχος του χρήστη είναι να μπορεί να επιλέξει ένα σύνολο ρούχων το οποίο θα έχει επεξεργαστεί με βάση τα χαρακτηρηστικά τα οποία έχει διαλέξει και έχει δηλώσει ο χρήστης.
3. Το πλαίσιο χρήσης εφαρμογής θα είναι στην επιλογή προσωποποιημένων ρούχων 
